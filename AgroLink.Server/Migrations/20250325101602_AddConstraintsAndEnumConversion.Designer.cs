...
namespace AgroLink.Server.Migrations
{
    ...
    [Migration("20250325101602_AddConstraintsAndEnumConversion")]
    partial class AddConstraintsAndEnumConversion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AgroLink.Server.Models.RegistrationRequest", b =>
                {
                    ...
                    b.ToTable("RegistrationRequests", t =>
                        {
                    ...
                    b.ToTable("Suppliers", t =>
                        {
                            ...
                            t.HasCheckConstraint("ValidBirthdate", "YEAR(GETDATE()) - YEAR(Birthdate) > 18 OR (YEAR(GETDATE()) - YEAR(Birthdate) = 18 AND (MONTH(GETDATE()) > MONTH(Birthdate) OR (MONTH(GETDATE()) = MONTH(Birthdate) AND DAY(GETDATE()) >= DAY(Birthdate)))) ");
                        });
                });
